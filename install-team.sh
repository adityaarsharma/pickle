...
echo "   /pickle-slack     — your Slack inbox scanner (optional)"
...
# ── Install skills (no pickle-report for team members) ──────────
echo ""
...
for deprecated in pickle-setup pickle-me pickle-report; do
  [ -d "$SKILLS_DIR/$deprecated" ] && rm -rf "$SKILLS_DIR/$deprecated" && echo "   ✓ Removed: $deprecated"
done
